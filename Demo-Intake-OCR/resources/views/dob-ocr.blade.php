...
@section('content')
    ...
    <p class="lead">Run OCR using position (x,y), store location JSON in <code>fp_dob_location</code>, then confirm the extracted text.</p>
    ...
    @else
        ...
        <div style="border:1px solid #d7dee6;border-radius:10px;background:#fff;padding:14px;margin-bottom:12px;">
            ...
            <div style="display:flex;gap:14px;align-items:flex-start;">
                <div style="flex:0 0 auto;">
                    ...
                    <p style="margin:6px 0 0;color:#5f6b7a;font-size:12px;">
                        Saves only the bounding area into <code>global_state.fp_dob_location.handwritten</code>.
                    </p>
                </div>
                <div id="hand-log"
                     style="flex:1;min-width:220px;max-height:150px;overflow-y:auto;
        ...
        <div style="border:1px solid #d7dee6;border-radius:10px;background:#fff;padding:14px;margin-top:12px;">
            ...
            <form id="human-confirm-form" action="{{ route('dob.confirm') }}" method="post" style="display:flex;gap:8px;flex-wrap:wrap;align-items:end;">
                @csrf
                <div style="min-width:260px;flex:1;">
                    <label style="display:block;font-size:12px;color:#475467;margin-bottom:4px;">Confirm Date Of Birth</label>
        ...
        <script>
            (function () {
                ...
                var handwrittenUrl = @json(route('dob.handwritten'));
                var areaUrl = @json(route('dob.area'));
                var optionsUrl = @json(route('dob.options'));
